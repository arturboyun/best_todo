...
Revision ID: 2d4c974df65b
Revises: 6d5aabfeef3e
Create Date: 2020-06-16 21:46:00.433386
...
revision = '2d4c974df65b'
down_revision = '6d5aabfeef3e'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('asddd', sa.String(), nullable=True),
    sa.Column('owner_id', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['owner_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_lists_id'), 'lists', ['id'], unique=False)
    op.create_index(op.f('ix_lists_title'), 'lists', ['title'], unique=True)
